...

{
...

    {
        ...
        return match ($estado) {
            ...
            'egresado_activo' => 'confirmacion_egresado_activo',
...

    {
        ...
        return match ($estado) {
            ...
            'egresado_activo' => 'ITM - Pre-registro exitoso - Egresado y estudiante activo',
...

    {
        ...
        return match ($estado) {
            ...
            'egresado_activo' => 'emails.egresado-activo',
