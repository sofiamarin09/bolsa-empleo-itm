...
<style>
        ...
        .badge { display: inline-block; background: #d1fae5; color: #065f46; padding: 6px 16px; border-radius: 16px; font-size: 14px; font-weight: 600; margin-bottom: 8px; }

        .badge2 { display: inline-block; background: #E6F1FB; color: #0C447C; padding: 6px 16px; border-radius: 16px; font-size: 14px; font-weight: 600; margin-bottom: 16px; }
...
<div class="info-box">
                ...
                Su información será gestionada por el Programa de Egresados ante el Servicio Público de Empleo (SPE). Este es el primer paso; una vez procesada su información, deberá continuar el proceso directamente en el portal del SPE.
</div>
</div>
<div class="footer">
