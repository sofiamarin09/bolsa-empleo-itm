...
<p>Hemos recibido tu solicitud de pre-registro en el sistema de la Bolsa de Empleo del ITM. Sin embargo, tu documento no fue encontrado en el Sistema de Información Académica (SIA), por lo que no ha sido posible vincularte como estudiante activo o egresado.</p>
<div class="datos">
...
<div class="info-box">
                Este sistema está dirigido exclusivamente a estudiantes activos y egresados del ITM. Si deseas acceder a oportunidades laborales, puedes registrarte directamente en el Servicio Público de Empleo (SPE).
</div>
<div class="spe-box">
<h3>Regístrate en el Servicio Público de Empleo</h3>
<p>Puedes continuar tu proceso de búsqueda de empleo registrándote en el portal del SPE. Te recomendamos hacerlo a través de alguno de los siguientes prestadores autorizados:</p>
<ul>
<li>Comfama</li>
