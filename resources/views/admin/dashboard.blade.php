...
<style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .notif-card .notif-value.warning { color: #854F0B; }
...
<p class="notif-value error">{{ $correosSpeFailed }}</p>
        ...
        <h3 class="section-title">Gestión SPE</h3>
<div class="notif-grid">
<div class="notif-card">
<div class="notif-icon success">
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#065f46" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg>
...
<div>
<p class="notif-label">Gestionados SPE</p>
<p class="notif-value success">{{ $gestionadosSpe }}</p>
</div>
</div>
<div class="notif-card">
<div class="notif-icon warning">
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#854F0B" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>
</div>
<div>
<p class="notif-label">Pendientes SPE</p>
<p class="notif-value warning">{{ $pendientesSpe }}</p>
</div>
</div>
</div>
